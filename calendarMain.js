...
aug.onclick = function() { $('.tableRow').show(); update("08","2016"); setupCalendar("2016", 8)};
...
sep.onclick = function() { $('.tableRow').show(); update("09","2016"); setupCalendar("2016", 9)};
...
oct.onclick = function() {  $('.tableRow').show();  update("10","2016"); setupCalendar("2016", 10)};
...
nov.onclick = function() { $('.tableRow').show();  update("11","2016"); setupCalendar("2016", 11)};
...
dec.onclick = function() {  $('.tableRow').show();  update("12","2016"); setupCalendar("2016", 12)};
...
jan.onclick = function() { $('.tableRow').show(); update("01","2017"); setupCalendar("2017", 1)};
...
feb.onclick = function() { $('.tableRow').show(); update("02","2017"); setupCalendar("2017", 2)};
...
mar.onclick = function() { $('.tableRow').show(); update("03","2017"); setupCalendar("2017", 3)};
...
apr.onclick = function() { $('.tableRow').show(); update("04","2017"); setupCalendar("2017", 4)};
...
may.onclick = function() { $('.tableRow').show(); update("05","2017"); setupCalendar("2017", 5)};
