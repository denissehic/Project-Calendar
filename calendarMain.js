...
function update(month,year) {
    currentMonth = month;
    currentYear = year;
    queryString = currentMonth + "20" + currentYear;
...
aug.setAttribute('class', 'w3-btn w3-xlarge w3-dark-grey w3-hover-light-grey w3-border-black');
aug.setAttribute('style','font-weight:900');
aug.appendChild(document.createTextNode('Aug'));
aug.onclick = function() {update("08","2016")};
...
sep.onclick = function() {update("09","2016")};
...
oct.onclick = function() {update("10","2016")};
...
nov.onclick = function() {update("11","2016")};

var dec = document.createElement('button');
dec.setAttribute('class', 'w3-btn w3-xlarge w3-dark-grey w3-hover-light-grey');
dec.setAttribute('style','font-weight:900');sep.setAttribute('class', 'w3-btn w3-xlarge w3-dark-grey w3-hover-light-grey');
sep.setAttribute('style','font-weight:900');
dec.appendChild(document.createTextNode('Dec'));
dec.onclick = function() {update("12","2016")};
...
jan.onclick = function() {update("01","2017")};
...
feb.onclick = function() {update("02","2017")};
...
mar.onclick = function() {update("03","2017")};
...
apr.onclick = function() {update("04","2017")};
...
may.onclick = function() {update("05","2017")};
